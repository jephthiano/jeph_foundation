			...
			<div class='j-color j-padding'>
				...
				<div class='j-padding-contact j-row'>
					<div class='j-col m6 j-padding'>
						<div>
							<div class='j-bolder'style='font-family:sofia'><i class="<?=icon('marker-o')?>"></i>Headquarter Address</div>
							<span class='j-itallic'><?=get_xml_data('address')?></span>
							<br><br>
						</div>
						<div>
							<b style='font-family:sofia'>Email</b><a href="mailto:<?=get_xml_data('business_email')?>"title='Oladejo Jephthah Email'class="j-button"><?=get_xml_data('business_email')?></a>
							<br><br>
						</div>
						<div>
							<b style='font-family:sofia'>Call</b><a href="tel:<?=get_xml_data('phonenumber')?>"class="j-button"title='Oladejo Jephthah Phonenumber'><i class="fa-flip-horizontal <?=icon('phone')?>"></i><?=get_xml_data('phonenumber')?></a>
							<br><br>
						</div>
						<div>
							<div class='j-bolder'style='font-family:sofia'>Connect With Us</div>
							<div class="j-panel" style="margin:0px;padding:5px"><?php get_all_social_handle('j-color3','j-text-light-gray')?></div>
							<br><br>
						</div>
					</div>
					<div class='j-col m6 j-padding'>
						...
						<form class=''>
							...
							<input type='text'id='sb'name='sb'class="ip j-input j-color4 j-color4 j-round-large j-border-2 j-border-color5"placeholder='Subject'value='<?=$subject?>'style="width:100%;max-width:400px;"/><br>
							...
							<button type='submit'id='sbtn'class="j-btn j-medium j-color3 j-round-large">Send Message</button>
						</form>
					</div>
				</div>
			</div>
