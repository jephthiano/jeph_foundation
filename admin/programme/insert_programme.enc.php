...
$page_url = file_location('admin_url','/programme/insert_programme/');
$page = "INSERT PROGRAMME";
...
<div class="j-row">
	...
	<div class="j-col s12 l10"><br>
		<div id="maincol"class='j-main-col'>
			<center>
				<br><br>
				<a href="<?=file_location('admin_url','programme/')?>" class="j-btn j-color1 j-right j-round j-card-4 j-bolder">Show All Programme</a>
				<br class='j-clearfix'>
			</center>
			<h2 class='j-text-color1 j-center'><b>INSERT NEW PROGRAMME</b></h2>
				<div class="j-container">
					...
					<form onsubmit="event.preventDefault();"class=''>
						...
						<br>
						<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round-large j-bolder">Insert Programme</button>
					</form>
					<span id="st"></span>
					<br><br>
				</div>
