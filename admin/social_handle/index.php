...
$page_url = file_location('admin_url','social_handle/');
...
<div class="j-row">
	...
	<div class="j-col s12 l10"><br>
		<div id="maincol">
			...
			<center>
				<br><h2 class='j-text-color1'><b>MANAGE SOCIAL HANDLES</b></h2>
				<div class='j-padding'>
				...
				<div class="j-container">
					...
					placeholder="Search all social handles"style="width:96%;max-width:500px;outline:none;display:inline"onsearch="gshr();"onkeyup="gshr();"/>
				</div>
				<div id="shr"></div>
			</center>
			<span id="st"></span>
