	...
	<div class="j-col s12 l10"><br>
		<div id="maincol"class='j-main-col'>
			...
			<center>
				...
				<br class='j-clearfix'>
				<h2 class='j-text-color1'><b>INSERT NEW SOCIAL HANDLE</b></h2>
			</center>
			<div class="j-container">
				<form onsubmit="event.preventDefault();"class=''>
					...
					<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round-large j-bolder">Insert New Social Handle</button>
				</form>
			</div>
			<br><br>
			<span id="st"></span>
