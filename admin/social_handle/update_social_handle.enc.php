		...
		<div id="maincol"class='j-main-col'>
			...
			<div class="j-container">
				...
				if($id === false){
					...
					?>
					<h2 class='j-text-color1 j-center'><b>UPDATE SOCIAL HANDLE</b></h2>
					<form onsubmit="event.preventDefault();"class=''>
						...
						<input type="text"class=" j-input j-medium j-border-2 j-border-color5 j-round-large"placeholder="Icon"
						...
						<input type="text"class=" j-input j-medium j-border-2 j-border-color5 j-round-large"placeholder="Link"
						...
						<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round-large j-bolder">Update Social Handle</button>
					</form>
					<?php
				}
				?>
