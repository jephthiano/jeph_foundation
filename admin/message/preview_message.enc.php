	...
	<div class="j-col s12 l10"><br>
		<div id="maincol"class='j-main-col'>
			...
			<center>
				<br><br>
				<div class='j-padding'>
					<a href="<?=file_location('admin_url','message/')?>" class="j-btn j-color1 j-left j-round j-card-4 j-bolder">Show All Messages</a>
				...
				<div class="j-container j-large">
					...
					if($id === false){
						...
						?>
						<h2 class='j-text-color1 j-center'><b>MESSAGE DATA</b></h2>
						<span class="j-right j-clickable j-text-color1" onclick="$('#message<?=$id?>').show()"><i class="j-xlarge <?=icon('cog')?>"></i></span>
						<div class="j-row-padding j-padding">
							
							<div class='j-col s4 j-text-color1'><b>NAME:</b></div>
							<div class='j-col s8'><?=ucwords(content_data('message_table','m_name',$id,'m_id'))?></div>
						</div>
						<div class="j-row-padding j-padding">
							<div class='j-col s4 j-text-color1'><b>EMAIL:</b></div>
							<div class='j-col s8'><?=content_data('message_table','m_email',$id,'m_id')?></div>
						</div>
						<div class="j-row-padding j-padding">
							<div class='j-col s4 j-text-color1'><b>STATUS:</b></div>
							<div class='j-col s8'><?=content_data('message_table','m_status',$id,'m_id')?></div>
						</div>
						<div class="j-row-padding j-padding">
							<div class='j-col s4 j-text-color1'><b>DATE:</b></div>
							<div class='j-col s8'><?=content_data('message_table','m_datetime',$id,'m_id')?></div>
						</div>
						<div class="j-row-padding j-padding">
							<div class='j-col s4 j-text-color1'><b>SUBJECT:</b></div>
							<div class='j-col s8'><?=ucwords(content_data('message_table','m_subject',$id,'m_id'))?></div>
						</div>
						<div class="j-row-padding j-padding">
							<div class='j-col s4 j-text-color1'><b>MESSAGE:</b></div>
							<div class='j-col s8'><?=ucwords((content_data('message_table','m_message',$id,'m_id')))?></div>
						</div>
						<?php
					}
					?>
				...
				<br><br>
				<span id="st"></span>
			<?php if($adid === 1 && $id !== false){ preview_modal('message',$id); } ?>
		</div>
	</div>
</div>
<!-- BODY ENDS -->
