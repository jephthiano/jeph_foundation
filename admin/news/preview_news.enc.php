			...
			<center>
				...
				<div class="j-container">
					...
					if($id === false){
						...
						<span class="j-right j-clickable j-text-color1" onclick="$('#news<?=$id?>').show();"><i class="j-xlarge <?=icon('cog')?>"></i></span>
						<div class='j-large j-bolder j-text-color1 j-padding'><span>Status: </span> <span> <?=ucwords((content_data('news_table','n_status',$cid,'n_id')))?></span></div>
