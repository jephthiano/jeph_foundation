...
<?php
$keyword = explode('|',$keywords);$len = count($keyword);
for($i = 0;$i < $len; $i++){?><meta property="article:tag"content="<?=$keyword[$i]?>"><meta name="news_keywords"content="<?=$keyword[$i]?>"><?php }
}
?>
