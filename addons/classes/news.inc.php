...
class news{
    ...
    public function insert_news(){
        if(content_data('news_table','n_id',$this->title,'n_title') !== false){
            ...
            try{
                ...
                $this->dbsql = "INSERT INTO {$this->table}(n_title,n_keyword,n_paragraph1,n_paragraph2,n_paragraph3,n_regdatetime)
    ...
    public function update_news(){
        $this->dbsql = "UPDATE {$this->table} SET n_title = :title,n_keyword = :keyword,n_paragraph1 = :paragraph1,n_paragraph2 = :paragraph2,
        n_paragraph3 = :paragraph3,n_regdatetime = :regdatetime WHERE n_id = :id LIMIT 1";
        $this->dbstmt = $this->dbconn->prepare($this->dbsql);
        $this->dbstmt->bindParam(':title',$this->title,PDO::PARAM_STR);
        $this->dbstmt->bindParam(':keyword',$this->keyword,PDO::PARAM_STR);
        $this->dbstmt->bindParam(':paragraph1',$this->paragraph1,PDO::PARAM_STR);
